...
CREATE TABLE `dingdan` (
  ...
  `shouhuodizhi` varchar(45) DEFAULT NULL,
  `youbian` varchar(45) DEFAULT NULL,
  `shouhuoren` varchar(45) DEFAULT NULL,
  `dianhua` varchar(45) DEFAULT NULL,
  `yonghuliuyan` varchar(45) DEFAULT NULL,
  `dingdancol` varchar(45) DEFAULT NULL,
  `dingdanzhuangtai` varchar(45) DEFAULT NULL,
  `fahuoshijian` datetime DEFAULT NULL,
  `querengshouhuoshijian` datetime DEFAULT NULL,
  `goumaizheid` int(11) DEFAULT NULL,
